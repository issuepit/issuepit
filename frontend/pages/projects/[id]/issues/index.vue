          ...
          <tr v-for="issue in store.filteredIssues" :key="issue.id"
            ...
            <td class="px-4 py-3">
              <div class="flex items-center gap-2 flex-wrap">
                ...
                <!-- When the GitHub number differs from the issue number (legacy imports), show GH#N -->
                <a
                  v-if="issue.gitHubIssueUrl && issue.gitHubIssueNumber !== issue.number"
                ...
                <!-- When the number is the same (native GitHub number import), show just the GitHub icon -->
                <a
                  v-else-if="issue.gitHubIssueUrl && issue.gitHubIssueNumber === issue.number"
                  :href="issue.gitHubIssueUrl"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="text-gray-600 hover:text-gray-400 shrink-0"
