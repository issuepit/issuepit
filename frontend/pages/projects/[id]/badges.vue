<template>
  <div class="p-8">
    ...
    <div class="flex items-center gap-3 mb-6">
      ...
      <div class="w-8 h-8 bg-pink-900/30 rounded-lg flex items-center justify-center">
      ...
      <div>
        <h1 class="text-xl font-bold text-white">Status Badges</h1>
        <p class="text-gray-500 text-sm">Embed live status badges into your README</p>
      </div>
    </div>
