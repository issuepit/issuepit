...
///     (default: <c>ghcr.io/issuepit/issuepit-helper-dind:latest</c>)</item>
...
{
    // Docker image used to run act. Uses the IssuePit helper-dind image which includes
    // .NET SDK, Playwright, Node.js, Docker CLI, and act (see docker/Dockerfile.helper-dind).
    private const string DefaultImage = "ghcr.io/issuepit/issuepit-helper-dind:latest";
