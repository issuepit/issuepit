...
public class IssuePitDbContext(DbContextOptions<IssuePitDbContext> options) : DbContext(options)
{
    ...
    public DbSet<MergeRequestReview> MergeRequestReviews => Set<MergeRequestReview>();
    ...
    public DbSet<GitRepoAutoFetchRun> GitRepoAutoFetchRuns => Set<GitRepoAutoFetchRun>();
    public DbSet<GitRepoAutoFetchRunLog> GitRepoAutoFetchRunLogs => Set<GitRepoAutoFetchRunLog>();
