...
[ApiController]
[Route("api/issues")]
public class IssuesController(IssuePitDbContext db, TenantContext ctx, IProducer<string, string> producer, ILogger<IssuesController> logger, IssueEnhancementService enhancementService) : ControllerBase
{
    [HttpGet]
