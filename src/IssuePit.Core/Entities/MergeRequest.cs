...
public class MergeRequest
{
    ...
    /// <summary>GitHub pull request number, set when this MR was imported from GitHub.</summary>
    public int? GitHubPrNumber { get; set; }

    /// <summary>GitHub pull request URL, set when this MR was imported from GitHub.</summary>
    [MaxLength(500)]
